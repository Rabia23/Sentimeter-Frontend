  ...
  .service('commentService', function(_, StatusEnum){
    ...
    return {
      getComment: function(comment_data){
        ...
        return {data: data, email: email, phone_no: phone_no, disable_view_comment_link: disable_view_comment_link, show_dropdown:show_dropdown, action_string: action_string, date_time: date_time, updated_time: updated_time};
      }
