  ...
  .service('commentService', function(_, StatusEnum){
    ...
    return {
      getComment: function(comment_data){
        ...
        var phone_no = comment_data.user_phone == "N/A" ? ( comment_data.email == "N/A" ? (comment_data.date_of_birth == "N/A"? "N/A" : "") : "" ) : comment_data.user_phone;
        var email = comment_data.email == "N/A" ? "" : comment_data.email;
        var dob = comment_data.date_of_birth == "N/A" ? "" : comment_data.date_of_birth;
        ...
        var disable_view_comment_link = false;
        ...
        return {data: data, email: email, phone_no: phone_no, dob: dob, disable_view_comment_link: disable_view_comment_link, show_dropdown:show_dropdown, action_string: action_string, date_time: date_time, updated_time: updated_time};
      }
