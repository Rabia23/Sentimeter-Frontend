describe('OpportunitiesCtrl', function(){
  ...
  var apilink = 'https://stagingapiginsoy.sentimeter.io/api/opportunity_analysis?branch=&city=&date_from=&date_to=&region=';
  ...
  describe('drawOpportunityAnalysis method', function(){
    ...
    it('show flash when api request failure', function(){
      ...
      $httpBackend.whenGET(apilink).respond({success: false });
      $httpBackend.flush();
